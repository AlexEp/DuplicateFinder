...
class ChiSquareHistogramComparator(BaseComparisonStrategy):
    """
    Compares image histograms using chi-square.
    """
    @property
    def option_key(self):
        return 'compare_histogram_chi_square'

    @property
    def db_key(self):
        return 'histogram_chi_square'

    def get_duplicates_query_part(self):
        return "fm.histogram_chi_square"

    def compare(self, hist1, hist2, method=None):
        """
        Compares two histograms using chi-square.
