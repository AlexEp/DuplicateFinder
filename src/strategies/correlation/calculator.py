...
class CorrelationHistogramCalculator(BaseCalculator):
    """
    Calculates image histograms for correlation comparison.
    """
    @property
    def db_key(self):
    ...
    def calculate(self, file_node, opts):
        ...
        if not opts.get('compare_histogram_correlation'):
            return None
