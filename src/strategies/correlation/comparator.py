...
class CorrelationHistogramComparator(BaseComparisonStrategy):
    """
    Compares image histograms using correlation.
    """
    @property
    def option_key(self):
        return 'compare_histogram_correlation'
    ...
    def get_duplicates_query_part(self):
        return "fm.histogram_correlation"
