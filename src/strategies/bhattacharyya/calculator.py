...
class BhattacharyyaHistogramCalculator(BaseCalculator):
    """
    Calculates image histograms for bhattacharyya comparison.
    """
    @property
    def db_key(self):
    ...
    def calculate(self, file_node, opts):
        ...
        if not opts.get('compare_histogram_bhattacharyya'):
            return None
